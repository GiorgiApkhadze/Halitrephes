...
<div class="hero__caption">
		<h1 style="text-align: left;position: absolute;font-family: inherit;color: #2268DD;margin-top: 21%;left: 6%;"> Sitemap</h1>
</div>
<div class="list-group" style="width: 40%;padding-top: 15%;padding-bottom: 5%;margin-left: 27%;">
  ...
  <a href="services.php" class="list-group-item list-group-item-action">Services</a>
	<a href="jobs.php" class="list-group-item list-group-item-action">Join</a>
