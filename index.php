...
<main>
    ...
    <div class="slider-area ">
        <div class="slider-active">
            ...
            <div class="single-slider slider-height d-flex align-items-center " style="background-image: url(images/baner.png); min-height: 703px;">
                            ...
                            <form action="#" class="search-box">
                                <div class="search-form" style="
														    border: 4px solid #FF855D;
																width: 219px;
																">
                                    <a href="about.php" style="#FF855D;"class="btn header-btn">Learn More</a>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    ...
                    <div class="single-cat text-center mb-50">
                        ...
                        <div class="cat-cap">
                            ...
                            <p style="width: 76%;">We work with governments and large prime contractors providing high-quality simultaneous, consecutive interpretation and translation services.</p>
														  <p style="margin-top: -5%;"><a href="services.php" style="text-align: initial;font-size: 18px; font-weight: bold; color: #FF855D;">Learn More ></a></p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="single-cat text-center mb-50">
                        ...
                        <div class="cat-cap">
                            ...
                            <p style="padding-bottom: 5px;">Build your contracting office with </br> experienced acquisition personnel</br></p>
														...
														<p style="margin-top: -10%;"><a href="services.php" style="text-align: initial;font-size: 18px;font-weight: bold; color: #FF855D;">Learn More ></a></p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                    ...
                    <div class="single-cat text-center mb-50">
                        <div class="cat-icon">
                            <span>
															<img src="assets/img/1.png" style="width: 190px;  position: relative;left: -172px	">
														</span>
                        </div>
                        <div class="cat-cap">
...
">
            <!-- Section Tittle -->
						<div class="left_half">
							...
							<form action="#" class="search-box">
									<div class="search-form">
											<a href="jobs.php"  class="btn header-btn" style=" width: 340px;color: #FF855D;font-weight: bold;margin-left: 20px;border: 4px solid #FF855D;">Team With Halitrephes </a>
									</div>
							</form>
						</div>
				...
				<div class="right_half">
					...
					<form action="#" class="search-box">
							<div class="search-form" >
									<a href="jobs.php" class="btn1" style="width: 340px;color: #7ba4ea;font-weight: bold;margin-left: 20px;border: 4px solid #2268DD;">Join Our Team</a>
							</div>
					</form>
				</div>
		</div>
