...
<div class="hero__caption">
		<h1 style="text-align: center;font-family: inherit;color: #272727;margin-top: 5%;"> How Can We Help?</h1>
</div>
<div class="container-contact100">
	...
	<div class="wrap-input100 validate-input" style="border-bottom: none;margin-bottom: -4%;    margin-top: 20%;">
			...
			<div class="wrap-input100 validate-input" style="border-bottom: none;margin-bottom: -4%;">
				<div class="flex-w size1 p-b-47">
					...
					<div class="flex-col size2">
						<span class="txt1 p-b-20">
						21 NORTH BROAD STREET,</br> SUITE D, LURAY, VA 22835
						</span>
			...
			<div class="container-contact100-form-btn">
				<div class="wrap-contact100-form-btn" style="color:#999999; margin-inline-end:auto;margin-top:20%;">
					<div class="contact100-form-bgbtn"></div>
					DUNS: 8903ND</br>
					CAGE: 0937027</br>
					NAICS: 093487; 303948; 304938
				</div>
			</div>
		</form>
	</div>
    ...
    <div class="footer-area footer-bg">
        <div class="container">
            ...
            <div class="row d-flex justify-content-between">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-5 col-sm-6" style="display: contents">
                        <div class="single-footer-caption mb-50" style="margin-bottom: 0px;">
                           <P style="color: white;"><i class="fa fa-envelope"></i> <a href="mailto:info@halitrephes.com" style="color: white;">info@halitrephes.com</a></P>
                        </div>
                    </div>
                </div>
        </div>
