...
<body>
    ...
    <main>
        <!--? slider Area Start-->
										...
										<div class="container" style="margin-left:26%;">
												<div class="row">
														<div class="col-xl-9 col-lg-9" style="text-align: center;">
																...
																<div class="hero-pera">
																		<p>Halitrephes was created to specifically address government information</br>
																			 technology and program management support requirements.</p>
																</div>
														</div>
												</div>
										</div>
				...
				<div class="flip-flop" style="  padding-bottom: 80px;  background-position: 1155px -196px;background-size: 71%;;background-repeat: no-repeat;background-image: url(assets/img/elipse.png);">
					<div class="fc-adv" >
